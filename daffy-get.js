...
function usage() {
	const usage = commandLineUsage([{ header: 'daffy-get.js', content: 'Pull the next item from a daffy server.' }, { header: 'Options', optionList: opts_def }]);
	console.log(usage);
	process.exit(0);
}
